...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, OrderStatusEvent> consumerFactory(KafkaProperties kafkaProperties) {
        ...
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "com.ecommerce.order.event,com.ecommerce.payment.event,com.ecommerce.inventory.event,com.ecommerce.*");
    ...
    @Bean
    public NewTopic orderStatusTopic(@Value("${app.kafka.topics.order-status}") String topic) {
